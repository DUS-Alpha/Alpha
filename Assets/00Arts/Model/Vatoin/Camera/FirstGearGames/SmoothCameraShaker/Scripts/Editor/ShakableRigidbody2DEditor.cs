...
namespace FirstGearGames.SmoothCameraShaker.EditorDesign
{
    ...
    public class ShakableRigidbody2DEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_shakerType, new GUIContent("Shaker AttackType", "Shaker AttackType to use. CameraShaker will subscribe to your current or otherwise configured CameraShaker. ObjectShaker will subscribe to the first ObjectShaker found on or in parented objects."));
            EditorGUI.EndDisabledGroup();

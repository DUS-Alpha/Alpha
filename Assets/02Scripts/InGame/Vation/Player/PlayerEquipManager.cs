...
namespace alpha
{
    ...
    public class PlayerEquipManager : MonoBehaviour, IEquipService, ISwapCondition
    {
        // ========== Equip Holder ==========
        ...
        private void Awake()
        {
            ...
            CurrentCountableItems = new Dictionary<ECountableTypes, UsetableItem>();
        ...
        private void EquipQuick_Potion(PotionItemDataSO potionData)
        {
            ...
            UsetableItem _countableItem = _countablePotionObj.GetComponent<UsetableItem>();

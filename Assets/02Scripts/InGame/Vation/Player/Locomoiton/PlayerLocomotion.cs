...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    {
        m_velocity = m_gravityUtility.ApplyGravity(BaseGravity, m_currentSpeed, m_moveDirByCamera, m_velocity, m_characterController);
        CheckGround();
    }
    ...
    public void FlyUpStart()
    {
        ...
        m_playerCore.AniController.SetIsFlyAni(m_isFlying, _isFlyUpStart);
    }
    public void FlyUp()
    {
        ApplyAntiGravity();
    ...
    {
        m_playerCore.AniController.SetIsFlyAni(m_isFlying, false);
    }
    ...
    public void FlyExit()
    {
        ...
        m_playerCore.AniController.SetIsFlyAni(m_isFlying, _isFlyUp);
    }
    #endregion ================================================================================ /Fly
}

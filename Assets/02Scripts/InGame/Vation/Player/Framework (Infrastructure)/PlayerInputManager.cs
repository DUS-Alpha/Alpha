...
namespace alpha
{
    public class PlayerInputManager : MonoBehaviour, ILocomotionInput
    {
        ...
        public bool IsDash { get; private set; }  // 다음 프레임에서 false로 변환해줌
